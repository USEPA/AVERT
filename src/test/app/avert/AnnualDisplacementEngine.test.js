  ...
  describe('Displaced Generations - Monthly Changes', () => {
    ...
    describe('Monthly Changes - Percentage ', () => {
      describe('Region level monthly percentages', () => {
        ...
        it('should have an avoided percent change of -0.0021 in January when using mock data', () => {
          if (usingMock) {
            expect(data.monthlyChanges.percentages.region[1]).toBe(-0.002102581877324797);
          }
        });
      });
      ...
      describe('State level monthly percentages', () => {
        ...
        it('should aggregate data into each month', () => {
          expect(data.monthlyChanges.percentages.state.NY[1]).toBe(-0.004619832242971493);
        });
      });
      ...
      describe('County level monthly percentage changes', () => {
        ...
        it('should aggregate avoided percentages into each month', () => {
          expect(data.monthlyChanges.percentages.county.NY.Albany[1]).toBe(-0.0047504984988327075);
        });
      })
    });
  });
