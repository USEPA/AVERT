  ...
  switch (action.type) {
    ...
    case FOO_COMPLETE_MONTHLY:
      ...
      return {
        ...
        regional: { so2: action.so2.regional.data, nox: action.nox.regional.data, co2: action.co2.regional.data },
        output: { so2: action.so2.regional.data, nox: action.nox.regional.data, co2: action.co2.regional.data },
