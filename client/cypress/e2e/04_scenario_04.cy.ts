describe("Test Scenario 4", () => {
  ...
  it("Annual Emissions Changes (Including Vehicles) table displays the correct results", () => {
    const so2 = ["7,703,350", "-845,230", "6,858,120"];
    const nox = ["21,240,870", "-6,580,530", "14,660,340"];
    const co2 = ["20,177,020", "-50,419,300", "-30,242,280"];
    const pm25 = ["1,698,120", "-1,248,370", "449,750"];
    const vocs = ["885,190", "-17,666,220", "-16,781,030"];
    const nh3 = ["1,090,330", "-8,254,950", "-7,164,630"];
