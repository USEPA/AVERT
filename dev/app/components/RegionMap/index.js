...
const RegionMap = () => (
  <div className='avert-region-map'>
    <svg xmlns='http://www.w3.org/2000/svg' width='720' height='500' viewBox='0 0 720 500'>
      ...
      <g id='avert-regions'>
        <RegionContainer name='Upper Midwest'>
          <UpperMidwest />
        </RegionContainer>

        <RegionContainer name='Texas'>
          <Texas />
        </RegionContainer>

        <RegionContainer name='Southwest'>
          <Southwest />
        </RegionContainer>

        <RegionContainer name='Southeast'>
          <Southeast />
        </RegionContainer>

        <RegionContainer name='Rocky Mountains'>
          <RockyMountains />
        </RegionContainer>

        <RegionContainer name='Northwest'>
          <Northwest />
        </RegionContainer>

        <RegionContainer name='Northeast'>
          <Northeast />
        </RegionContainer>

        <RegionContainer name='Lower Midwest'>
          <LowerMidwest />
        </RegionContainer>

        <RegionContainer name='Great Lakes / Mid-Atlantic'>
          <GreatLakes />
        </RegionContainer>

        <RegionContainer name='California'>
          <California />
        </RegionContainer>
      </g>
